            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <div class="grid gap-6 mb-8 md:grid-cols-2 xl:grid-cols-4">
                        ...
                        <div class="flex items-center p-4 bg-white rounded-lg shadow-md dark:bg-gray-800">
                            <div class="p-3 mr-4 text-red-500 bg-red-100 rounded-full dark:text-teal-100 dark:bg-teal-500">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-5">
                        <div class="p-5 bg-white shadow-md rounded-md">
                            <p class="font-medium text-lg">Jenis Kelamin Masyarakat</p>
                            {{-- Disini canvas chart.js nya --}}
                            <canvas id="genderChartPetugas" class="max-w-lg max-h-80"></canvas>
                        </div>
                        <div class="p-5 bg-white shadow-md rounded-md">
                            <p class="font-medium text-lg">Rata-rata aduan dikirim/bulan</p>
                            {{-- Disini canvas chart.js nya --}}
                            <canvas id="monthlyComplaintsChart" class="max-w-lg max-h-80"></canvas>
