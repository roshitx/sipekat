<div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
    <div class="p-12 text-gray-800 overflow-x-auto">
        <div class="max-w-full">
            ...
            <p class="mt-2 mb-1 text-xs lg:text-sm font-semibold flex items-center">
                ...
                <span class="ml-2 text-gray-500">{{ $complaint->village }}, {{ $complaint->district }}, {{ $complaint->regency }}, {{ $complaint->province }}</span>
            </p>
            @endif
