...
<input {{ $disabled ? 'disabled' : '' }} :type="show ? 'password' : 'text'" type="password" name="password" placeholder="{{ $placeholder ? $placeholder : ''}}" {!! $attributes->merge(['class' => 'border-gray-300 focus:border-primary focus:ring-primary rounded-md shadow-sm']) !!}>
